...
With shell (70/592) and kafka (45/296) that is **2 801 tests over six tracks**, every one of
them green against the real implementation. `byo` carries a six-entry registry (98 tests), the
site renders six trails from those catalogs (348 stage pages prerendered), and `install.sh`
