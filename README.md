...
| [`disttest/`](disttest/README.md) | a **distributed key/value store**, in three ladders — 55 stages, 475 tests | etcd 3.7.1 |
...
**2 208 tests across six tracks.** You write the shell, the broker, the runtime, the server,
